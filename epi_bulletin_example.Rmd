...
## Measles Lab data has dates stored as numeric dates in excel - but with a mix of formats (m/d/y and d/m/y). Manually convert it to csv first then read into R to get the text values instead of Excel date values.
measles_lab <- rio::import("data/measles_lab.csv")
